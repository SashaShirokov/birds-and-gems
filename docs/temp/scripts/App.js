...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
	    function StickyHeader() {
	        ...
	        this.headerTriggerElement = (0, _jquery2.default)("#our-beginning");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Level1State = __webpack_require__(8);

	var _Level1State2 = _interopRequireDefault(_Level1State);

	var _Level2State = __webpack_require__(9);

	var _Level2State2 = _interopRequireDefault(_Level2State);

	var _Level3State = __webpack_require__(10);

	var _Level3State2 = _interopRequireDefault(_Level3State);

	var _TitleState = __webpack_require__(11);

	var _TitleState2 = _interopRequireDefault(_TitleState);

	var _OverState = __webpack_require__(12);

	var _OverState2 = _interopRequireDefault(_OverState);

	var _Stage1State = __webpack_require__(13);

	var _Stage1State2 = _interopRequireDefault(_Stage1State);

	var _Stage2State = __webpack_require__(14);

	var _Stage2State2 = _interopRequireDefault(_Stage2State);

	var _GameOverState = __webpack_require__(15);

	var _GameOverState2 = _interopRequireDefault(_GameOverState);

	var _WinnerState = __webpack_require__(16);

	var _WinnerState2 = _interopRequireDefault(_WinnerState);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, 800, 480, Phaser.AUTO, "ph_game"));

	    _this.state.add('Level1', _Level1State2.default, false);
	    _this.state.add('Level2', _Level2State2.default, false);
	    _this.state.add('Level3', _Level3State2.default, false);
	    _this.state.add('Title', _TitleState2.default, false);
	    _this.state.add('Over', _OverState2.default, false);
	    _this.state.add('Stage1', _Stage1State2.default, false);
	    _this.state.add('Stage2', _Stage2State2.default, false);
	    _this.state.add('GameOver', _GameOverState2.default, false);
	    _this.state.add('Winner', _WinnerState2.default, false);
	    _this.state.start('Title');
	    return _this;
	  }
...
/***/ function(module, exports) {
	...
	var Level1 = function (_Phaser$State) {
	    ...
	    _createClass(Level1, [{
	        ...
	        key: "onSwallow",
	        value: function onSwallow(bird, fruit) {
	            fruit.kill();
	            this.score++;
	            if (this.score === 10) {
	                this.backgroundMusic.stop();
...
/***/ function(module, exports) {
	...
	var Level2 = function (_Phaser$State) {
	    ...
	    _createClass(Level2, [{
	        ...
	        key: "resetGoal",
	        value: function resetGoal() {
	            var goals = this.game.rnd.integerInRange(0, 5);
...
/***/ function(module, exports) {
	...
	var Level3 = function (_Phaser$State) {
	    _inherits(Level3, _Phaser$State);

	    function Level3() {
	        _classCallCheck(this, Level3);

	        return _possibleConstructorReturn(this, (Level3.__proto__ || Object.getPrototypeOf(Level3)).apply(this, arguments));
	    }
	    ...
	    _createClass(Level3, [{
	        ...
	        value: function create() {
	            ...
	            // Fruit
	            this.fruit = this.game.add.group();
	            this.fruit.createMultiple(25, "fruit");
	            this.fruit.setAll("checkWorldBounds", true);
	            this.fruit.setAll("outOfBoundsKill", true);

	            // Worms
	            this.worms = this.game.add.group();
	            this.worms.createMultiple(1, "worms");
	            this.worms.setAll("checkWorldBounds", true);
	            this.worms.setAll("outOfBoundsKill", true);
	            ...
	            // Enable bird to have gravity
	            this.game.physics.enable([this.bird, this.fruit, this.worms], Phaser.Physics.ARCADE);
	            this.bird.body.gravity.y = 350;
	            this.bird.body.immovable = true;
	        ...
	        value: function fireFruit() {
	            var fruit = this.fruit.getFirstDead();
	            var yy = this.game.rnd.integerInRange(0, this.game.height - 70);
	            var xx = this.game.width - 30;
	            var type = this.game.rnd.integerInRange(0, 5);

	            fruit.frame = type;
	            fruit.reset(xx, yy);
	            fruit.enabled = true;
	            fruit.body.velocity.x = -225;
	        }
	    }, {
	        key: "flap",
	        value: function flap() {
	        ...
	        key: "onPoison",
	        value: function onPoison(bird, worms) {
	            worms.kill();
	            this.bar1.width = this.bar1.width - 7;
	        }
	    }, {
	        key: "resetGoal",
	        value: function resetGoal() {
	        ...
	        value: function update() {
	            this.game.physics.arcade.collide(this.bird, this.fruit, null, this.onSwallow, this);
	            this.game.physics.arcade.collide(this.bird, this.worms, null, this.onPoison, this);
	            this.goalGroup.y = this.bird.y - 50;
	            this.goalGroup.x = this.bird.x;
	            if (this.game.input.activePointer.isDown) {
	                this.flap();
	            }
	...
	var Title = function (_Phaser$State) {
	    ...
	    _createClass(Title, [{
	        ...
	        value: function create() {
	            ...
	            this.titleText = this.game.add.text(this.game.world.centerX, 60, "Birds & Gems", {
	        ...
	        key: "wrongWay",
	        value: function wrongWay() {
	            document.getElementById("wrongWay").style.display = "block";
	        }
	    }, {
	        key: "rightWay",
	        value: function rightWay() {
...
/***/ function(module, exports) {
	...
	var Stage2 = function (_Phaser$State) {
	    ...
	    function Stage2() {
	        ...
	        return _possibleConstructorReturn(this, (Stage2.__proto__ || Object.getPrototypeOf(Stage2)).apply(this, arguments));
	    }
...
/***/ function(module, exports) {
	...
	var Winner = function (_Phaser$State) {
	    _inherits(Winner, _Phaser$State);
